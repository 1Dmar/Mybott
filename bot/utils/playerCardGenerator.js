...
async function generatePlayerCard(ign, template = 'darkmode', stats = null) {
    ...
    //
    const frameX = 42;
    const frameY = 50;   // داخل البطاقة (panelY=30 + هامش 20)
    const frameW = 170;
    const frameH = 200;  // أقصر عشان ما يطلع من البطاقة
    ...
    if (skinImg) {
        ...
        // Pass B: re-stroke frame on top so it appears in front of skin
