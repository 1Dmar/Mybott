...
| Plan | Price | Positioning | Implemented access |
|---|---:|---|---|
| Free | $0/month | Help small servers grow. | Core Discord/Minecraft connection, basic telemetry, health, activity, onboarding, alerts, recommendations, and limited automation/report usage. |
| Pro | $4.99/month | Help me grow my server. | Advanced intelligence, player journey, retention, cohort, advanced automation, reports, and notifications when the subscription is active. |
| Ultimate | $9.99/month | Help me operate and scale my network. | Network intelligence, multi-instance analytics, network reports/notifications, and advanced security feature keys when active. |
